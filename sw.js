const VERSION = '2.6.0';
const CACHE_NAME = 'cue-timer-v2-6-0';
const CORE_ASSETS = [
  './',
  './index.html',
  './cue_timer_v2_6_0.html',
...
self.addEventListener('fetch', event => {
  ...
  if(request.mode === 'navigate' || url.pathname.endsWith('/index.html') || url.pathname.endsWith('/cue_timer_v2_6_0.html')){
