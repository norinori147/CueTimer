const VERSION = '3.0.2';
const BUILD = '2026.07.25.03';
const CACHE_NAME = 'cue-timer-v3-0-2';
const CORE_ASSETS = [
  './',
  './index.html',
  './cue_timer_v3_0_2.html',
...
self.addEventListener('fetch', event => {
  ...
  if(request.mode==='navigate'||url.pathname.endsWith('/index.html')||url.pathname.endsWith('/cue_timer_v3_0_2.html')){event.respondWith(networkFirst(request));return;}
